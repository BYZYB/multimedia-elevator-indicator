...
void Media::read_media_file() {
    ...
    const QStringList image_list = image_dir.entryList({"*.bmp", "*.jpg", "*.jpeg", "*.png"}, QDir::Files | QDir::Readable, QDir::Name), video_list = video_dir.entryList({"*.avi", "*.mp4"}, QDir::Files | QDir::Readable, QDir::Name);
