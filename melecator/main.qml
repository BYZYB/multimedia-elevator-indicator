...
Window {
    ...
    Text {
        ...
        onTextChanged: {
            animation_text_elevator_floor.start()
        }

        ParallelAnimation {
            id: animation_text_elevator_floor
    ...
    Item {
        ...
        Text {
            ...
            onTextChanged: {
                animation_text_elevator_direction.start()
            }
        }

        PropertyAnimation {
            id: animation_text_elevator_direction
    ...
    Item {
        ...
        Text {
            ...
            onTextChanged: {
                animation_text_elevator_next_stop.start()
            }
        }
        ...
        PropertyAnimation {
            id: animation_text_elevator_next_stop

            duration: 500
            easing.type: Easing.InOutCubic
            from: 0
            property: "opacity"
            targets: [image_elevator_next_stop, text_elevator_next_stop]
            to: 1
        }
    }
